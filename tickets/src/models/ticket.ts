...
ticketSchema.set('versionKey', 'version'); // telling mongoose to use version field insted of __V
ticketSchema.plugin(updateIfCurrentPlugin); // this pluging will handle versioning
